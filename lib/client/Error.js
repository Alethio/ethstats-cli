export default class Error {
  ...
  constructor(protocol) {
    ...
    this.solutions = {
      ...
      'Method not found': `=> Possible fix: Parity must be run with ${_parityRecommendedFlags[protocol]} to enable the necessary apis.`,
      'The method (\\w+) does not exist/is not available': `=> Possible fix: Geth must be run with ${_gethRecommendedFlags[protocol]} to enable the necessary apis.`,
