...
config.configServer.host = process.env.CONFIG_SERVER_HOST || config.configServer.host;
config.configServer.port = process.env.CONFIG_SERVER_PORT || config.configServer.port;
