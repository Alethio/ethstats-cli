...
`, {
    ...
    if (cli.flags.serverHost === true || cli.flags.serverHost === '') {
      this.log.error('Server Host is empty', false, true);
    }

    if (cli.flags.serverPort === true || cli.flags.serverPort === '') {
      this.log.error('Server Port is empty', false, true);
    }
