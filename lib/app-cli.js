...
config.configServer.host = process.env.ETHSTATS_CONFIG_SERVER_HOST || config.configServer.host;
config.configServer.port = process.env.ETHSTATS_CONFIG_SERVER_PORT || config.configServer.port;
